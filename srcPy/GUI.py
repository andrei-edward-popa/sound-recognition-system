...
f = open('/home/apopa/Gitroot/Sound-Recognition-System/utils/SerialData', 'r+')
f.truncate(0)
f.close()

os.chdir('/home/apopa/Gitroot/Sound-Recognition-System/srcPy')
os.system('gnome-terminal -- bash -c "minicom -b 921600 -D /dev/ttyACM0 -C /home/apopa/Gitroot/Sound-Recognition-System/utils/SerialData; exec bash"')
